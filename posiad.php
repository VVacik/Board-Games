...
<body>
    ...
    <main>
        ...
        <nav class="search-section" id='jump'>
            ...
            <option hidden disabled selected value> wybierz </option>
                ...
                <div class="inpulabe" id="Cenowy">
                    ...
                    <input class="input" type="range" id="price" name="price" min="100" max="1000" step="100">
                    <label for="price" class="cenavalue">100</label>
                </div>
                <div class="inpulabe">
                    <label class="label" for="players">Max graczy:</label>
                    <input class="input" type="number" id="players" name="players" min="1" max="12">
                </div>

                <input type="submit" name="wyszukaj" class="search-button" value="wyszukaj">
            </form>
        </nav>
        <h1 id="góra">Gry posiadane: </h1>
        ...
        <div class="rekord-container">
            ...
            $sql = "SELECT * FROM gry WHERE 1=1 AND stan='1'";
            $types = '';
            $params = array();
        ...
        <a href="#jump"><img id="powrot" src="./zdjecia/up-arrow.png" alt=""></a>
        <div id="edit-form" style="display: none;">
            <input type="text" id="edit-image" placeholder="Nazwa obrazka">
            <input type="text" id="edit-title" placeholder="Tytuł">
            <input type="number" id="edit-players" placeholder="Liczba graczy">
            <input type="number" id="edit-price" placeholder="Cena">
            <input type="text" id="edit-tutorial" placeholder="Link do tutorialu">
